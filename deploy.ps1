...
$files = @(
    @{
        Path = "pc-version-final\dist\XinTuAlbum 1.1.0.exe"
        Name = "便携版"
    },
    @{
        Path = "pc-version-final\dist\XinTuAlbum-Setup-1.1.0.exe"
        Name = "安装版"
    },
    @{
...
# 压缩便携版
$portableSource = "pc-version-final\dist\XinTuAlbum 1.1.0.exe"
...
# 压缩安装版
$setupSource = "pc-version-final\dist\XinTuAlbum-Setup-1.1.0.exe"
