...
echo.
echo 正在启动应用程序...
if exist "dist\芯图相册-智能分类，便捷管理，仅你可见 1.0.0.exe" (
    start "" "dist\芯图相册-智能分类，便捷管理，仅你可见 1.0.0.exe"
) else if exist "芯图相册-智能分类，便捷管理，仅你可见 1.0.0.exe" (
    start "" "芯图相册-智能分类，便捷管理，仅你可见 1.0.0.exe"
) else (
    echo 错误：找不到应用程序文件！
    echo 请确保EXE文件在正确的位置
)
